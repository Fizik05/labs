...
{
    internal class First_console_app
    {
        ...
        public First_console_app()
        {
            _urls = new List<string> { "http://localhost:8080/first_serve", "https://api.thecatapi.com/v1/images/search", "http://localhost:8081/second_server" };
