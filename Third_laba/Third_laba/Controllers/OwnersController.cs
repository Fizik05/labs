    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Owners != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Owners'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LastName")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,LastName")] Owner owner)
        {
            if (id != owner.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Owners'  is null.");
            }
            var owner = await _context.Owners.FindAsync(id);
            if (owner != null)
            {
