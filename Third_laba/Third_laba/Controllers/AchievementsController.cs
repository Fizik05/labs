...
namespace Third_laba.Controllers
{
    public class AchievementsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title")] Achievement achievement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title")] Achievement achievement)
        {
